...
// since sort is case sensitive, map takes an array and modifys it to be all lowercase, then sorts it, and prints the sorted list.
let lowerList = simpleList.map(function(fruit) {
    return fruit.toLowerCase();
});

//sort then print the lowercase list
